...
export const tooltipInfoMessages = {
  tvl: 'Total Value Deposited, is the dollar amount of all VSQ staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.',
  mvt: 'Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.',
  rfv: 'Risk Free Value, is the amount of funds the treasury guarantees to use for backing VSQ.',
  ...
  holder: 'Holders, represents the total number of Vesqers (sVSQ holders)',
  staked: 'VSQ Staked, is the ratio of sVSQ to VSQ (staked vs unstaked)',
  ...
  runway: 'Runway, is the number of days sVSQ emissions can be sustained at a given rate. Lower APY = longer runway',
  currentIndex:
    'The current index tracks the amount of sVSQ accumulated since the beginning of staking. Basically, how much sVSQ one would have if they staked and held a single VSQ from day 1.',
};
