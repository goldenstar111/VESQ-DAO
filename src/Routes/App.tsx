...
import { Bond, ChooseBond, Stake, VSQBalance, ISO, IVSQ, IIVSQ, PVSQ, Wrap } from '../views';
import NotFound from '../views/404/NotFound';
import ISO2 from '../views/ISO2';
import './style.scss';
      ...
      <div className={`app ${isSmallerScreen && 'tablet'} ${isSmallScreen && 'mobile'}`}>
        ...
        <div className={`${classes.content} ${isSmallerScreen && classes.contentShift}`}>
          <Switch>
            ...
            {/* <Route path="/iso">
              <Route exact path="/iso/vsq">
                <VSQBalance bondKey={'mai_vsq'} />
              </Route>
              <ISO />
            </Route>
            <Route path="/iso2">
            ...
            <Route path="/stake">
              <Route exact path="/stake/vsq">
                <VSQBalance bondKey={'frax_vsq'} />
              </Route>
              <Stake />
            </Route>
            <Route path="/bonds">
